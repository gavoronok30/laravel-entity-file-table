...
return [
    ...
    */
    ...
    | Model
    |--------------------------------------------------------------------------
    | Default: \Gavoronok30\LaravelEntityFileTable\Model\FileModel::class
    | Change to your custom class if you need to extend the model or change the table name
    | A custom class must inherit the base class \Gavoronok30\LaravelEntityFileTable\Model\FileModel
    */
